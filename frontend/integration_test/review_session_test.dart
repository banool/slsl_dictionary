...
// repetition session driven through the real UI. Ported from auslan_dictionary;
// SLSL saves videos by media path and doesn't filter the flashcard pool by
// region, so there's no KEY_FLASHCARD_REGIONS to seed. It exercises:
...
void main() {
  ...
  testWidgets(
    ...
    // at exactly kSessionCards, both card directions on. Start review history
    // from empty so the post-session count is exact.
