...
# (scripts/android_upload.sh); this sets SLSL's app-specific values and hands
# over. Expects appci checked out as a sibling of this repo's parent, or set
# APPCI_DIR.
#
...
export PLAY_PACKAGE_NAME=com.banool.slsl_dictionary
