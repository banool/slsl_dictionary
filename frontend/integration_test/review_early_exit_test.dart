...
// goes straight back to the revision landing page. Ported from auslan_dictionary
// (SLSL saves by media path and doesn't filter the flashcard pool by region).
...
void main() {
  ...
  testWidgets(
    ...
    // kSessionCards, both card directions on. Start review history from empty so
    // the persisted counts are exact.
