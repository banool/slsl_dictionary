...
Future<void> mdSetup() async {
  ...
  // SLSL ships no bundled dictionary; it's fetched at runtime. Resolve
  // saved-video paths to URLs through mediaBaseUrls (set before phase three so
  // the list migration can use them), and point the loader at the network dump
  // — like lib/main.dart, but pinned to the direct bucket for determinism
  // rather than going through the useCdnUrl knob.
