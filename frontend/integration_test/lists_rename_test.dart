...
// renamed through the UI. Ported from auslan_dictionary; the rename flow lives
// in dictionarylib's lists overview, so the only SLSL-specific change is that
// saved videos are keyed by media path (SavedVideo.mediaPath), not full URL.
//
