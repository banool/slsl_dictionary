...
# this sets SLSL's app-specific values and hands over. Expects dictionarylib
# checked out as a sibling of this repo's root (one level above frontend/),
...
export PUBLISH_BUNDLE_ID=com.banool.slsldictionary
export PUBLISH_BETA_GROUP="SLSL Testers"
